...
class TestSyncAutoMergeLabel(unittest.TestCase):
    def test_positive_authorization_candidate_policy(self):
        ...
        current_fleet_pr = {
            "user": {"login": "human"},
            "head": {
                "ref": "fix-42-live-canary-14900125275473977334",
                "repo": {"full_name": repo},
            },
            "body": (
                "Fixes #42\n"
        ...
        self.assertTrue(
            is_positive_authorization_candidate(current_fleet_pr, repo)
        )
        ...
        self.assertTrue(
            is_positive_authorization_candidate(legacy_fleet_pr, repo)
        )
        ...
        rejected = (
            ...
            {
                **current_fleet_pr,
                "labels": fleet_labels + [{"name": "fleet-review-required"}],
            },
            {
                "user": {"login": "dependabot[bot]"},
                "labels": [{"name": "dependencies"}],
